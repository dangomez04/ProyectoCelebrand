...
|
*/
$config['base_url'] = 'http://localhost/revi_project/PROJECT';
...
|
*/
$config['encryption_key'] = 'wakamole5684';
...
$config['sess_expiration'] = 7889400; // 3 Meses
...
$config['cookie_domain']    = ''; // revi.io / devrevi.com / En localhost vacío
$config['cookie_path']        = '/';
